	...
	class Tribe_Filters {
		...
		public function enqueue() {
			...
			if ( $current_screen->id == 'edit-' . $this->filtered_post_type ) {
				...
				wp_enqueue_script(
					'tribe-filters', $resources_url . 'tribe-filters.js', array(
					'jquery-ui-sortable',
		...
		protected function saved_filters_dropdown() {
			...
			<div class="apm-saved-filters">
				<h2 class="select-saved-filter"><?php echo esc_html__( 'Saved Filter Set', 'advanced-post-manager' ); ?>
					<span>s</span></h2>
